...
const Role = () => {
    ...
    const loading = useAppSelector(state => state.roleManagementReducer.loading);
    const loadingDelete = useAppSelector(state => state.roleManagementReducer.loadingDelete);
    const listRole = useAppSelector(state => state.roleManagementReducer.listRole);
    ...
    const _onDelete = async () => {
        ...
        listSelected.forEach(item => listDelete.push(item.roleCd));

        dispatch(deleteRole(createCommonIParamsListDuong({ "listData": listDelete }))).then(res => {
    ...
    const _onSearchAction = async () => {
        ...
        const payload = createCommonIParamsDuong({ roleCd, roleNm, sys, status, pageRequestDto });
