...
const EditScrapingManagement = ({ isEdit, selected, onChangeFormAdd }) => {
            ...
            <div className="content">
                ...
                <Form form={formRegis} className="custom-form edit-department__form">
                    ...
                    <Row align="middle" style={{ marginBottom: 12 }}>
                        ...
                        <Col xs={10} md={3}>
                            <span className="cms-search-label">Dozn Service Url</span>
                        </Col>

                        <Col xs={14} md={5}>
                            <Form.Item name="doznServiceUrl">
...
export default EditScrapingManagement;