...
import { changeTabActive, removeTab, reset, sortAgainTab, updateTabIsEditing } from '../../../shared/layout/tab/tabs.reducer';
import TabItem from '../../../shared/layout/tab/tab-item';

const RegisterAssignmentStudent = importedComponent(() => import('@/app/modules/user-side/student-side/register-assignment-student/RegisterAssignmentStudent'), {
