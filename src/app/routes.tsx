...
import StudentSite from './modules/user-side/layout-user-side/layout-student';
  ...
  return (
    <>
      <RoutesRoute>
        ...
        <Route path="/student/login" element={<LoginUser />} />
        <Route path="/instructor/login" element={<LoginInstructor />} />
        <Route path="/student" element={<StudentSite />} />
